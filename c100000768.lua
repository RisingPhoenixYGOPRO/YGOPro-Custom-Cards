...
function c100000768.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(100000768,0))
	e2:SetCategory(CATEGORY_TODECK)
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetRange(LOCATION_GRAVE+LOCATION_REMOVED)
	e2:SetTarget(c100000768.tg)
	e2:SetOperation(c100000768.op)
	c:RegisterEffect(e2)
...
function c100000768.tg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsAbleToExtra() end
	Duel.SetOperationInfo(0,CATEGORY_TODECK,e:GetHandler(),1,0,0)
end
function c100000768.op(e,tp,eg,ep,ev,re,r,rp)
