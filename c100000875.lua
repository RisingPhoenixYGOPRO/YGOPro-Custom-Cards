...
function c100000875.initial_effect(c)
	...
	e3:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0x10E))
...
function c100000875.filt(c)
	return c:IsSetCard(0x10E) and not c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsFaceup()
end
...
function c100000875.damtg(e,tp,eg,ep,ev,re,r,rp,chk)
