...
function c100000765.initial_effect(c)
	...
	e13:SetValue(c100000765.atkup)
	c:RegisterEffect(e13)
end
function c100000765.atkfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x11A)
end
function c100000765.atkup(e,c)
	return Duel.GetMatchingGroupCount(c100000765.atkfilter,c:GetControler(),LOCATION_MZONE,0,nil)*200
end
