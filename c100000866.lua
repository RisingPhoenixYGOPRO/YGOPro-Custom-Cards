...
function c100000866.cost1(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=Duel.SelectMatchingCard(tp,c100000866.cfilter,tp,LOCATION_HAND,0,1,1,nil)
...
function c100000866.cfilter(c)
	return  c:IsSetCard(0x10E) and c:IsType(TYPE_MONSTER) and c:IsAbleToGraveAsCost()
end
